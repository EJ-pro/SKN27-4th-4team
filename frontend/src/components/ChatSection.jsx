...
const QUICK_BTNS = ['오늘 운동 추천', '초보자 시작 방법', '70분', '헬스장', '홈', '초급', '중급', '고급']

const CHAT_SCRIPT = [
  {
    role: 'user',
    text: '벤치프레스할 때 어깨가 너무 아픈데 회전근개 때문일까? 대체할 만한 가슴 운동도 알려줘.',
    delay: 0
  },
  {
    role: 'ai',
    text: '벤치프레스 시 어깨 통증은 회전근개(특히 극상근)의 충돌 증후군이나 전면 삼각근의 과개입 때문일 가능성이 높습니다. 바벨이 바닥과 수직을 이루는지, 어깨가 으쓱 올라가지 않았는지 점검이 필요해요.',
    delay: 1500
  },
  {
    role: 'ai',
    text: '어깨 부담을 줄이면서 가슴을 타겟팅할 수 있는 대체 운동을 추천해 드릴게요.\n\n1. 덤벨 프레스: 바벨과 달리 손목 각도를 조절할 수 있어 어깨 스트레스를 줄여줍니다.\n2. 푸시업 (패러렐 그립): 견갑골의 자연스러운 움직임을 유도해 어깨가 안전합니다.',
    delay: 3500
  },
  {
    role: 'user',
    text: '덤벨 프레스 할 때 덤벨 각도는 어떻게 해야 어깨가 안 아파?',
    delay: 5500
  },
  {
    role: 'ai',
    text: '덤벨을 완전히 일자(ㅡ)로 두지 마시고, 위에서 봤을 때 화살표 모양(↖ ↗)이 되도록 15~30도 정도 안쪽으로 살짝 돌려주세요. 이렇게 하면 어깨 관절 구멍(관절와순) 내에서 팔뼈가 부딪히지 않고 안전하게 움직입니다.',
    delay: 7000
  },
  {
    role: 'ai',
    text: '💡 [참고 문서: NSCA 체력 관리 가이드 - 상체 프리웨이트 부상 방지 프로토콜]',
    delay: 8500
  }
]
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 40 }}>
            {[
              ...
              { Icon: SlidersHorizontal, color: '#7C72FF', text: '내 몸에 딱 맞는 맞춤형 운동 매칭' },
